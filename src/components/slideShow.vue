<template>
  <div class="slide-box clearfix">
    <div class="slide-show clearfix" @mouseover="clearInv" @mouseout="runInv">
      <div class="slide-img">
        <a :href="slides[nowIndex].clickUrl" @mousewheel="gotoimg">
    ...
    <div class="slide-pages">
      ...
      <div class="ulbox" id="ulbox" ref="ulbox" style="overflow: hidden;">
        <ul class="slideul" @mousewheel="runover" id="ul" ref="slideul" style="margin-top: 10px;"
    ...
    methods: {
      ...
      gotoimg(e) {
        ...
        if (deltaY > 0) {
          // up
          this.isShow = true
          if(this.nowIndex<=this.slides.length-2){
            this.nowIndex++;
          }else{
